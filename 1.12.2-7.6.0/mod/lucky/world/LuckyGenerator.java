...
public class LuckyGenerator implements IWorldGenerator
{
    ...
    public void generate(final Random a6, final int v1, final int v2, final World v3, final IChunkGenerator v4, final IChunkProvider v5) {
        try {
            /*SL:36*/switch (v3.field_73011_w.getDimension()) {
                case -1: {
                    /*SL:38*/for (final DropContainer a7 : this.netherDrops) {
                        /*SL:39*/if (a6.nextInt((int)a7.getChance()) == 0) {
                            /*SL:40*/this.generateNether(v3, a6, v1 * 16, v2 * 16, a7);
                        }
                    }
                    /*SL:41*/break;
                }
                case 0: {
                    /*SL:43*/for (final DropContainer a8 : this.surfaceDrops) {
                        /*SL:44*/if (a6.nextInt((int)a8.getChance()) == 0) {
                            /*SL:45*/this.generateSurface(v3, a6, v1 * 16, v2 * 16, a8);
                        }
                    }
                    /*SL:46*/break;
                }
                case 1: {
                    /*SL:48*/for (final DropContainer a9 : this.endDrops) {
                        /*SL:49*/if (a6.nextInt((int)a9.getChance()) == 0) {
                            /*SL:50*/this.generateEnd(v3, a6, v1 * 16, v2 * 16, a9);
                        }
                    }
                    break;
                }
            ...
            System.err.println(/*EL:54*/"Lucky Block: Error during natural generation");
            /*SL:55*/a10.printStackTrace();
        }
    }
    ...
    private void generateEnd(final World a1, final Random a2, int a3, int a4, final DropContainer a5) {
        ...
        /*SL:73*/a4 += a2.nextInt(16) + 8;
        /*SL:74*/this.generate(a1, new BlockPos(a3, 100, a4), a5);
    }
    
    private void generate(final World a1, BlockPos a2, final DropContainer a3) {
        /*SL:78*/a2 = this.getSurfacePos(a1, a2);
        /*SL:79*/if (a2 != null) {
            /*SL:80*/this.block.getDropProcessor().processDrop(a3, new DropProcessData(a1, null, a2));
        }
    }
    
    public void addSurfacedDrop(final DropContainer a1) {
        /*SL:84*/this.addDrop(this.surfaceDrops, a1);
    }
    
    public void addNetherDrop(final DropContainer a1) {
        /*SL:88*/this.addDrop(this.netherDrops, a1);
    }
    
    public void addEndDrop(final DropContainer a1) {
        /*SL:92*/this.addDrop(this.endDrops, a1);
    }
    
    private void addDrop(final ArrayList<DropContainer> a1, final DropContainer a2) {
        /*SL:96*/if (!a2.wasChanceSet()) {
            a2.setChance(300.0f);
        }
        /*SL:97*/a1.add(a2);
    }
    ...
    private BlockPos getSurfacePos(final World v1, final BlockPos v2) {
        int v3 = /*EL:101*/v2.func_177956_o();
        boolean v4 = /*EL:102*/false;
        /*SL:110*/do {
        ...
        /*SL:112*/return v4 ? new BlockPos(v2.func_177958_n(), v3, v2.func_177952_p()) : null;
    }
}
