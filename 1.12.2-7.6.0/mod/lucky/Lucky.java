...
@Mod(modid = "lucky", name = "Lucky Block", version = "7.6.0", acceptedMinecraftVersions = "[1.12.2]")
public class Lucky
{
    @Mod.Instance("lucky")
    ...
    public void init(final FMLInitializationEvent a1) {
        ...
        /*SL:114*/EntityRegistry.registerModEntity(new ResourceLocation("lucky", "LuckyProjectile"), (Class)EntityLuckyProjectile.class, "LuckyProjectile", Lucky.ENTITY_ID++, (Object)this, 128, 20, true);
        /*SL:124*/EntityRegistry.registerModEntity(new ResourceLocation("lucky", "LuckyPotion"), (Class)EntityLuckyPotion.class, "LuckyPotion", Lucky.ENTITY_ID++, (Object)this, 128, 20, true);
        /*SL:134*/GameRegistry.registerTileEntity((Class)TileEntityLuckyBlock.class, "luckyBlockData");
        /*SL:135*/GameRegistry.registerWorldGenerator((IWorldGenerator)Lucky.lucky_block.getWorldGenerator(), 1);
        /*SL:137*/this.tickHandler = new LuckyTickHandler();
        MinecraftForge.EVENT_BUS.register(/*EL:138*/(Object)this.tickHandler);
        /*SL:140*/Rotations.registerRotationHandlers();
    }
    
    public static Lucky getInstance() {
        /*SL:144*/return Lucky.instance;
    }
    ...
    public ResourceLoader getResourceLoader() {
        /*SL:151*/return Lucky.resourceLoader;
    }
    
    public LuckyTickHandler getTickHandler() {
        /*SL:155*/return this.tickHandler;
    }
    
    public static ArrayList<Structure> getStructures() {
        /*SL:159*/return Lucky.structures;
    }
    
    public static Structure getStructure(final String v1) {
        /*SL:163*/for (final Structure a1 : Lucky.structures) {
            if (v1.equals(a1.getId())) {
                return a1;
            }
        }
        /*SL:164*/return null;
