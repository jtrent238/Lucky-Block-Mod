...
public class ParticlePacket implements IMessage
{
    ...
    public void fromBytes(final ByteBuf a1) {
        /*SL:27*/this.tag = ByteBufUtils.readTag(a1);
    }
    
    public void toBytes(final ByteBuf a1) {
        /*SL:32*/ByteBufUtils.writeTag(a1, this.tag);
    }
    ...
    public static class Handler implements IMessageHandler<ParticlePacket, IMessage>
    {
        public IMessage onMessage(final ParticlePacket v1, final MessageContext v2) {
            final String v3 = /*EL:38*/v1.tag.func_74779_i("name");
            EnumParticleTypes v4 = EnumParticleTypes.EXPLOSION_NORMAL;
            /*SL:40*/for (final EnumParticleTypes a1 : EnumParticleTypes.values()) {
                /*SL:41*/if (a1.func_179346_b().equals(v3)) {
                    /*SL:42*/v4 = a1;
                    /*SL:43*/break;
                }
            }
            /*SL:46*/Minecraft.func_71410_x().field_71441_e.func_175688_a(v4, /*EL:50*/v1.tag.func_74769_h("x"), /*EL:51*/v1.tag.func_74769_h("y"), /*EL:52*/v1.tag.func_74769_h("z"), 0.0, 0.0, 0.0, new int[0]);
            /*SL:56*/return null;
        }
    }
}
