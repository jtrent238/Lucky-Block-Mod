...
public class SchematicStructure extends Structure
{
    ...
    public void process(final DropProcessData v-5) {
        ...
        final Vec3 vecPos = /*EL:31*/dropProperties.getVecPos();
        ...
        /*SL:54*/for (final NBTTagCompound v2 : this.tileEntities) {
            /*SL:55*/StructureUtils.setTileEntity(v-5.getWorld(), TileEntity.func_145827_c(v2), this.getCenterPos(), vecPos, intValue);
        }
