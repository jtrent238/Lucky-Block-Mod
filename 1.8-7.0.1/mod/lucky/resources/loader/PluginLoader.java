...
public class PluginLoader extends BaseLoader
{
    ...
    public void initializePlugin() {
        try {
            /*SL:50*/RecipeSorter.register(Block.field_149771_c.func_177774_c((Object)this.getBlock()).toString(), (Class)LuckyCrafting.class, RecipeSorter.Category.SHAPELESS, "after:minecraft:shapeless");
