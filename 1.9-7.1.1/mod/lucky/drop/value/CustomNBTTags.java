...
public class CustomNBTTags
{
    ...
    public static NBTTagCompound getPotionEffect(final int a1, final int a2, final int a3) {
        final NBTTagCompound v1 = /*EL:107*/new NBTTagCompound();
        /*SL:109*/v1.func_74774_a("Id", (byte)a1);
        /*SL:110*/v1.func_74774_a("Amplifier", (byte)a2);
        /*SL:111*/v1.func_74768_a("Duration", a3);
        /*SL:113*/return v1;
    }
    
    public static ArrayList<NBTTagCompound> getRandomList(final int v1, final int v2, final NBTTagCompound... v3) {
        final int v4 = /*EL:118*/v3.length - (CustomNBTTags.random.nextInt(v2 + 1 - v1) + v1);
        final ArrayList<NBTTagCompound> v5 = /*EL:120*/new ArrayList<NBTTagCompound>(v3.length);
        /*SL:121*/for (final NBTTagCompound a1 : v3) {
            /*SL:123*/v5.add((NBTTagCompound)a1.func_74737_b());
        }
        /*SL:126*/for (int a2 = 0; a2 < v4; ++a2) {
            final int a3 = CustomNBTTags.random.nextInt(/*EL:128*/v5.size());
            /*SL:129*/v5.remove(a3);
        }
        /*SL:132*/return v5;
    }
    ...
    public static NBTTagList getRandomEnchantmentList(final int a2, final int a3, final NBTTagCompound... v1) {
        final ArrayList<NBTTagCompound> v2 = getRandomList(/*EL:137*/a2, a3, v1);
        final NBTTagList v3 = /*EL:139*/new NBTTagList();
        /*SL:140*/for (final NBTTagCompound a4 : v2) {
            /*SL:142*/a4.func_74777_a("lvl", (short)(CustomNBTTags.random.nextInt(a4.func_74765_d("lvl")) + 1));
            /*SL:143*/v3.func_74742_a((NBTBase)a4);
        }
        /*SL:146*/return v3;
    }
    
    public static NBTTagList getRandomPotionEffectList(final int a3, final int v1, final NBTTagCompound... v2) {
        final ArrayList<NBTTagCompound> v3 = getRandomList(/*EL:151*/a3, v1, v2);
        final NBTTagList v4 = /*EL:153*/new NBTTagList();
        /*SL:154*/for (final NBTTagCompound a4 : v3) {
            /*SL:156*/a4.func_74774_a("Amplifier", (byte)CustomNBTTags.random.nextInt(a4.func_74771_c("Amplifier") + 1));
            final int a5 = /*EL:157*/(int)(a4.func_74762_e("Duration") / 3.0f);
            /*SL:158*/a4.func_74768_a("Duration", CustomNBTTags.random.nextInt(a4.func_74762_e("Duration") + 1 - a5) + a5);
            /*SL:159*/v4.func_74742_a((NBTBase)a4);
        }
        /*SL:162*/return v4;
    }
    
    public static NBTBase getNBTTagFromString(String v-1, final DropProcessData v0) {
        /*SL:169*/if (v-1.equals("#luckySwordEnchantments")) {
        ...
        /*SL:170*/if (v-1.equals("#luckyAxeEnchantments")) {
        ...
        /*SL:174*/if (v-1.equals("#luckyChestplateEnchantments")) {
        ...
        /*SL:175*/if (v-1.equals("#luckyLeggingsEnchantments")) {
            return (NBTBase)getRandomEnchantmentList(4, 6, CustomNBTTags.protection, CustomNBTTags.fireProtection, CustomNBTTags.blastProtection, CustomNBTTags.projectileProtection, CustomNBTTags.thorns, CustomNBTTags.unbreaking);
        }
        /*SL:176*/if (v-1.equals("#luckyBootsEnchantments")) {
        ...
        /*SL:178*/if (v-1.equals("#luckyBowEnchantments")) {
        ...
        /*SL:183*/if (v-1.equals("#luckyPotionEffects")) {
        ...
        /*SL:184*/if (v-1.equals("#unluckyPotionEffects")) {
        ...
        /*SL:186*/if (v-1.equals("#randFireworksRocket")) {
            return (NBTBase)LuckyFunction.getRandomFireworksRocket();
        }
        /*SL:188*/if (v-1.startsWith("#randLaunchMotion")) {
            try {
                float v = /*EL:192*/0.9f;
                int v2 = /*EL:193*/15;
                /*SL:194*/if (v-1.startsWith("#randLaunchMotion(")) {
                    final String a1 = /*EL:196*/v-1.substring(v-1.indexOf(40) + 1, v-1.lastIndexOf(41));
                    final String[] a2 = /*EL:197*/DropStringUtils.splitBracketString(a1, ',');
                    /*SL:198*/a2[0] = DropStringUtils.removeNumSuffix(a2[0]);
                    /*SL:199*/v = ValueParser.getFloat(a2[0], v0);
                    /*SL:200*/v2 = ValueParser.getInteger(a2[1], v0);
                }
                final float v3 = /*EL:203*/MathHelper.func_76142_g(CustomNBTTags.random.nextFloat() * 360.0f);
                final float v4 = /*EL:204*/-90.0f + (CustomNBTTags.random.nextInt(v2 * 2) - v2);
                final float v5 = /*EL:205*/-MathHelper.func_76126_a(v3 / 180.0f * 3.1415927f) * MathHelper.func_76134_b(v4 / 180.0f * 3.1415927f) * v;
                final float v6 = /*EL:206*/MathHelper.func_76134_b(v3 / 180.0f * 3.1415927f) * MathHelper.func_76134_b(v4 / 180.0f * 3.1415927f) * v;
                final float v7 = /*EL:207*/-MathHelper.func_76126_a(v4 / 180.0f * 3.1415927f) * v;
                final NBTTagList v8 = /*EL:209*/new NBTTagList();
                /*SL:210*/v8.func_74742_a((NBTBase)new NBTTagDouble((double)v5));
                /*SL:211*/v8.func_74742_a((NBTBase)new NBTTagDouble((double)v7));
                /*SL:212*/v8.func_74742_a((NBTBase)new NBTTagDouble((double)v6));
                /*SL:213*/return (NBTBase)v8;
            }
            catch (Exception ex) {}
        }
        /*SL:220*/if (v-1.startsWith("#motionFromDirection(")) {
            try {
                final String v9 = /*EL:224*/v-1.substring(v-1.indexOf(40) + 1, v-1.lastIndexOf(41));
                final String[] v10 = /*EL:225*/DropStringUtils.splitBracketString(v9, ',');
                /*SL:226*/v10[2] = DropStringUtils.removeNumSuffix(v10[2]);
                final int v11 = /*EL:228*/ValueParser.getInteger(v10[0], v0);
                final int v12 = /*EL:229*/ValueParser.getInteger(v10[1], v0);
                final float v5 = /*EL:230*/ValueParser.getFloat(v10[2], v0);
                final float v6 = /*EL:231*/-MathHelper.func_76126_a(v11 / 180.0f * 3.1415927f) * MathHelper.func_76134_b(v12 / 180.0f * 3.1415927f) * v5;
                final float v7 = /*EL:232*/MathHelper.func_76134_b(v11 / 180.0f * 3.1415927f) * MathHelper.func_76134_b(v12 / 180.0f * 3.1415927f) * v5;
                final float v13 = /*EL:233*/-MathHelper.func_76126_a(v12 / 180.0f * 3.1415927f) * v5;
                final NBTTagList v14 = /*EL:235*/new NBTTagList();
                /*SL:236*/v14.func_74742_a((NBTBase)new NBTTagDouble((double)v6));
                /*SL:237*/v14.func_74742_a((NBTBase)new NBTTagDouble((double)v13));
                /*SL:238*/v14.func_74742_a((NBTBase)new NBTTagDouble((double)v7));
                /*SL:239*/return (NBTBase)v14;
            }
            catch (Exception ex2) {}
        }
        /*SL:246*/if (v-1.startsWith("#bowMotion")) {
            try {
                float v = /*EL:250*/1.0f;
                float v15 = /*EL:251*/0.0f;
                /*SL:252*/if (v-1.startsWith("#bowMotion(")) {
                    final String v16 = /*EL:254*/v-1.substring(v-1.indexOf(40) + 1, v-1.lastIndexOf(41));
                    final String[] v17 = /*EL:255*/DropStringUtils.splitBracketString(v16, ',');
                    /*SL:256*/v17[0] = DropStringUtils.removeNumSuffix(v17[0]);
                    /*SL:257*/if (v17.length > 1) {
                        v17[1] = DropStringUtils.removeNumSuffix(v17[1]);
                    }
                    /*SL:258*/v = ValueParser.getFloat(v17[0], v0);
                    /*SL:259*/if (v17.length > 1) {
                        v15 = ValueParser.getFloat(v17[1], v0);
                    }
                }
                final Entity v18 = /*EL:262*/v0.getPlayer();
                EntityArrow v19;
                /*SL:264*/if (v18 instanceof EntityLivingBase) {
                    v19 = (EntityArrow)new EntityTippedArrow(v0.getWorld(), (EntityLivingBase)v18);
                }
                else {
                    /*SL:265*/v19 = (EntityArrow)new EntityTippedArrow(v0.getWorld(), v18.field_70165_t, v18.field_70163_u, v18.field_70161_v);
                }
                /*SL:266*/v19.func_184547_a(v18, v18.field_70125_A + MathHelper.func_151240_a(v0.getWorld().field_73012_v, -v15, v15), v18.field_70177_z + MathHelper.func_151240_a(v0.getWorld().field_73012_v, -v15, v15), 0.0f, v0.getBowPower(), 1.0f);
                final NBTTagList v20 = /*EL:268*/new NBTTagList();
                /*SL:269*/v20.func_74742_a((NBTBase)new NBTTagDouble(v19.field_70159_w));
                /*SL:270*/v20.func_74742_a((NBTBase)new NBTTagDouble(v19.field_70181_x));
                /*SL:271*/v20.func_74742_a((NBTBase)new NBTTagDouble(v19.field_70179_y));
                /*SL:272*/return (NBTBase)v20;
            }
            catch (Exception ex3) {}
        }
        /*SL:279*/v-1 = v-1.replace("#chestVillageBlacksmith", "#chestLootTable(" + LootTableList.field_186423_e.func_110623_a() + ")");
        /*SL:280*/v-1 = v-1.replace("#chestBonusChest", "#chestLootTable(" + LootTableList.field_186420_b.func_110623_a() + ")");
        /*SL:281*/v-1 = v-1.replace("#chestDungeonChest", "#chestLootTable(" + LootTableList.field_186422_d.func_110623_a() + ")");
        /*SL:283*/if (v-1.startsWith("#customChestLootTable(")) {
            try {
                final String v9 = /*EL:287*/ValueParser.getString(v-1.substring(v-1.indexOf(40) + 1, v-1.lastIndexOf(41)));
                final LootTable.Serializer v21 = /*EL:288*/new LootTable.Serializer();
                final LootTable v22 = (LootTable)CustomNBTTags.GSON_INSTANCE.fromJson(/*EL:289*/v9, (Class)LootTable.class);
                final TileEntityChest v23 = /*EL:291*/new TileEntityChest();
                final LootContext.Builder v24 = /*EL:292*/new LootContext.Builder((WorldServer)v0.getWorld());
                /*SL:293*/if (v0.getPlayer() != null && v0.getPlayer() instanceof EntityPlayer) {
                    v24.func_186469_a(((EntityPlayer)v0.getPlayer()).func_184817_da());
                }
                /*SL:295*/v22.func_186460_a((IInventory)v23, CustomNBTTags.random, v24.func_186471_a());
                final NBTTagCompound v25 = /*EL:297*/new NBTTagCompound();
                /*SL:298*/v23.func_145841_b(v25);
                /*SL:299*/return (NBTBase)v25.func_150295_c("Items", 10);
            }
            catch (Exception v26) {
                System.err.println(/*EL:304*/"Lucky Block: Error creating chest from .json loot table");
                /*SL:305*/v26.printStackTrace();
            }
        }
        /*SL:309*/if (v-1.startsWith("#chestLootTable(")) {
            final TileEntityChest v27 = /*EL:311*/new TileEntityChest();
            final String v28 = /*EL:312*/ValueParser.getString(v-1.substring(v-1.indexOf(40) + 1, v-1.lastIndexOf(41)));
            /*SL:313*/v27.func_145834_a(v0.getWorld());
            /*SL:314*/v27.func_184287_a(new ResourceLocation("minecraft", v28), CustomNBTTags.random.nextLong());
            /*SL:315*/v27.func_70301_a(0);
            final NBTTagCompound v29 = /*EL:317*/new NBTTagCompound();
            /*SL:318*/v27.func_145841_b(v29);
            /*SL:319*/return (NBTBase)v29.func_150295_c("Items", 10);
        }
        /*SL:322*/return null;
    }
