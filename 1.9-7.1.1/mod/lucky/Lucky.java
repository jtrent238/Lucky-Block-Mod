...
@Mod(modid = "lucky", name = "Lucky Block", version = "7.1.1", acceptedMinecraftVersions = "[1.9]")
public class Lucky
{
    @Mod.Instance("lucky")
    ...
    public void init(final FMLInitializationEvent a1) {
        (Lucky.networkHandler = NetworkRegistry.INSTANCE.newSimpleChannel(/*EL:74*/"LuckyBlock")).registerMessage(/*EL:75*/(Class)ParticlePacket.Handler.class, (Class)ParticlePacket.class, 0, Side.CLIENT);
        Lucky.lucky_block_plugins = /*EL:77*/new ArrayList<PluginLoader>();
        Lucky.structures = /*EL:78*/new ArrayList<Structure>();
        (Lucky.lucky_block = /*EL:81*/(BlockLuckyBlock)new BlockLuckyBlock(Material.field_151575_d).func_149663_c("luckyBlock").func_149711_c(0.2f).func_149752_b(6000000.0f).func_149647_a(CreativeTabs.field_78030_b)).setHarvestLevel(/*EL:82*/"pickaxe", 0);
        /*SL:83*/GameRegistry.registerBlock((Block)Lucky.lucky_block, (Class)ItemLuckyBlock.class, "lucky_block");
        /*SL:87*/GameRegistry.registerItem((Item)(Lucky.lucky_sword = (ItemLuckySword)new ItemLuckySword().func_77655_b("luckySword").func_77637_a(CreativeTabs.field_78037_j)), "lucky_sword");
        /*SL:91*/GameRegistry.registerItem((Item)(Lucky.lucky_bow = (ItemLuckyBow)new ItemLuckyBow().func_77655_b("luckyBow").func_77637_a(CreativeTabs.field_78037_j)), "lucky_bow");
        /*SL:95*/GameRegistry.registerItem((Item)(Lucky.lucky_potion = (ItemLuckyPotion)new ItemLuckyPotion().func_77655_b("luckyPotion").func_77637_a(CreativeTabs.field_78026_f)), "lucky_potion");
        final int v1 = /*EL:98*/EntityRegistry.findGlobalUniqueEntityId();
        /*SL:99*/EntityRegistry.registerGlobalEntityID((Class)EntityLuckyProjectile.class, "LuckyProjectile", v1);
        /*SL:100*/EntityRegistry.registerModEntity((Class)EntityLuckyProjectile.class, "LuckyProjectile", v1, (Object)this, 128, 20, true);
        final int v2 = /*EL:103*/EntityRegistry.findGlobalUniqueEntityId();
        /*SL:104*/EntityRegistry.registerGlobalEntityID((Class)EntityLuckyPotion.class, "LuckyPotion", v2);
        /*SL:105*/EntityRegistry.registerModEntity((Class)EntityLuckyPotion.class, "LuckyPotion", v2, (Object)this, 128, 20, true);
