...
public class ClientProxy extends CommonProxy
{
    ...
    public void register() {
        ...
        /*SL:59*/for (final PluginLoader pluginLoader : Lucky.lucky_block_plugins) {
            /*SL:61*/Minecraft.func_71410_x().func_175599_af().func_175037_a().func_178086_a(Item.func_150898_a((Block)pluginLoader.getBlock()), 0, new ModelResourceLocation(((ResourceLocation)Block.field_149771_c.func_177774_c((Object)pluginLoader.getBlock())).toString(), "inventory"));
            ...
            /*SL:65*/if (pluginLoader.getBow() != null) {
                final String v2 = ((ResourceLocation)Item.field_150901_e.func_177774_c(/*EL:67*/(Object)pluginLoader.getBow())).toString();
