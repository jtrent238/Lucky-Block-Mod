...
public class BlockLuckyBlock extends BlockContainer
{
        ...
        try {
            ...
            /*SL:97*/if (!v-8.field_72995_K) {
                ...
                /*SL:125*/if (a5 != null) {
                    ...
                    /*SL:126*/this.getDropProcessor().processRandomDrop(new DropProcessData(v-8, (Entity)v-7, v-6), luck);
                }
                /*SL:127*/return true;
            }
        }
    ...
    public boolean canBlockStay(final World a1, final BlockPos a2) {
        ...
        /*SL:155*/return v1.func_176200_f(a1, a2) && v1 != Blocks.field_150355_j && v1 != Blocks.field_150358_i && v1 != Blocks.field_150353_l && v1 != Blocks.field_150356_k && (a1.getBlockLightOpacity(a2) >= 8 || a1.func_175710_j(a2)) && v2 != null && this.canStayOnBlock(v2);
    }
    
    public TileEntity func_149915_a(final World a1, final int a2) {
        /*SL:161*/return new TileEntityLuckyBlock();
    }
    ...
    public void func_180633_a(final World a1, final BlockPos a2, final IBlockState a3, final EntityLivingBase a4, final ItemStack a5) {
        final TileEntityLuckyBlock v1 = /*EL:167*/(TileEntityLuckyBlock)a1.func_175625_s(a2);
        /*SL:168*/if (v1 == null) {
            return;
        }
        final int v2 = /*EL:170*/ItemLuckyBlock.getLuck(a5);
        final String[] v3 = /*EL:171*/ItemLuckyBlock.getDrops(a5);
        /*SL:173*/v1.setLuck(v2);
        /*SL:174*/if (v3 != null && v3.length != 0) {
            v1.setDrops(v3);
        }
        /*SL:176*/v1.func_70296_d();
        /*SL:177*/a1.func_175689_h(a2);
        /*SL:179*/if (a1.func_175640_z(a2) && !a1.field_72995_K) {
            this.removeLuckyBlock(a1, null, a2, true);
        }
    }
    
    public DropProcessor getDropProcessor() {
        /*SL:184*/return this.dropProcessor;
    }
    
    public LuckyGenerator getWorldGenerator() {
        /*SL:189*/return this.worldGenerator;
    }
    
    public LuckyCrafting getCrafting() {
        /*SL:194*/return this.crafting;
    }
    
    public boolean getCrativeModeDrops() {
        /*SL:199*/return this.creativeModeDrops;
    }
    
    public void setCrativeModeDrops(final boolean a1) {
        /*SL:204*/this.creativeModeDrops = a1;
    }
