...
public class LuckyFunction
{
    ...
    public static NBTTagCompound getRandomFireworksRocket() {
        final Random random = /*EL:64*/new Random();
        final NBTTagCompound nbtTagCompound = /*EL:66*/new NBTTagCompound();
        final NBTTagCompound nbtTagCompound2 = /*EL:67*/new NBTTagCompound();
        final NBTTagCompound nbtTagCompound3 = /*EL:68*/new NBTTagCompound();
        final NBTTagList list = /*EL:69*/new NBTTagList();
        /*SL:72*/nbtTagCompound3.func_74774_a("Type", (byte)random.nextInt(5));
        /*SL:73*/nbtTagCompound3.func_74757_a("Flicker", random.nextBoolean());
        /*SL:74*/nbtTagCompound3.func_74757_a("Trail", random.nextBoolean());
        final int n = /*EL:75*/random.nextInt(4) + 1;
        final int[] v0 = /*EL:76*/new int[n];
        /*SL:77*/for (int v = 0; v < n; ++v) {
            /*SL:79*/v0[v] = Integer.valueOf(ItemDye.field_150922_c[random.nextInt(14)]);
        }
        /*SL:81*/nbtTagCompound3.func_74783_a("Colors", v0);
        /*SL:84*/list.func_74742_a((NBTBase)nbtTagCompound3);
        /*SL:87*/nbtTagCompound2.func_74782_a("Explosions", (NBTBase)list);
        /*SL:88*/nbtTagCompound2.func_74774_a("Flight", (byte)(random.nextInt(2) + 1));
        /*SL:91*/nbtTagCompound.func_74782_a("Fireworks", (NBTBase)nbtTagCompound2);
        /*SL:92*/return nbtTagCompound;
    }
    
    public static int getRandomPotionDamage() {
        /*SL:97*/return calculatePotionDamage(getRandomPotionEffect(), 0);
    }
    
    public static int calculatePotionDamage(final int a1, final int a2) {
        int v1 = /*EL:104*/0;
        int v2 = /*EL:105*/0;
        final int v3 = LuckyFunction.random.nextInt(/*EL:106*/3);
        /*SL:107*/if (v3 == 1) {
            v1 = 32;
        }
        /*SL:108*/if (v3 == 2) {
        ...
        int v4 = /*EL:111*/0;
        /*SL:112*/if (a2 == 0) {
            /*SL:114*/if (LuckyFunction.random.nextInt(2) == 0) {
                v4 = 16384;
            }
        }
        else/*SL:116*/ if (a2 == 1) {
        ...
        /*SL:119*/return a1 + v1 + v2 + v4;
    }
    
    @Deprecated
    public static EntityLiving getMobByNameOrId(final World a1, final String a2, final int a3) {
        /*SL:126*/if (a2.equals(LuckyFunction.mobNameList[0]) || a3 == LuckyFunction.mobIDList[0]) {
            return (EntityLiving)new EntityCreeper(a1);
        }
        /*SL:127*/if (a2.equals(LuckyFunction.mobNameList[1]) || a3 == LuckyFunction.mobIDList[1]) {
            return (EntityLiving)new EntitySkeleton(a1);
        }
        /*SL:128*/if (a2.equals(LuckyFunction.mobNameList[2]) || a3 == LuckyFunction.mobIDList[2]) {
            return (EntityLiving)new EntitySpider(a1);
        }
        /*SL:129*/if (a2.equals(LuckyFunction.mobNameList[3]) || a3 == LuckyFunction.mobIDList[3]) {
            return (EntityLiving)new EntityGiantZombie(a1);
        }
        /*SL:130*/if (a2.equals(LuckyFunction.mobNameList[4]) || a3 == LuckyFunction.mobIDList[4]) {
            return (EntityLiving)new EntityZombie(a1);
        }
        /*SL:131*/if (a2.equals(LuckyFunction.mobNameList[5]) || a3 == LuckyFunction.mobIDList[5]) {
            return (EntityLiving)new EntitySlime(a1);
        }
        /*SL:132*/if (a2.equals(LuckyFunction.mobNameList[6]) || a3 == LuckyFunction.mobIDList[6]) {
            return (EntityLiving)new EntityGhast(a1);
        }
        /*SL:133*/if (a2.equals(LuckyFunction.mobNameList[7]) || a3 == LuckyFunction.mobIDList[7]) {
            return (EntityLiving)new EntityPigZombie(a1);
        }
        /*SL:134*/if (a2.equals(LuckyFunction.mobNameList[8]) || a3 == LuckyFunction.mobIDList[8]) {
            return (EntityLiving)new EntityEnderman(a1);
        }
        /*SL:135*/if (a2.equals(LuckyFunction.mobNameList[9]) || a3 == LuckyFunction.mobIDList[9]) {
            return (EntityLiving)new EntityCaveSpider(a1);
        }
        /*SL:136*/if (a2.equals(LuckyFunction.mobNameList[10]) || a3 == LuckyFunction.mobIDList[10]) {
            return (EntityLiving)new EntitySilverfish(a1);
        }
        /*SL:137*/if (a2.equals(LuckyFunction.mobNameList[11]) || a3 == LuckyFunction.mobIDList[11]) {
            return (EntityLiving)new EntityBlaze(a1);
        }
        /*SL:138*/if (a2.equals(LuckyFunction.mobNameList[12]) || a3 == LuckyFunction.mobIDList[12]) {
            return (EntityLiving)new EntityMagmaCube(a1);
        }
        /*SL:139*/if (a2.equals(LuckyFunction.mobNameList[13]) || a3 == LuckyFunction.mobIDList[13]) {
            return (EntityLiving)new EntityDragon(a1);
        }
        /*SL:140*/if (a2.equals(LuckyFunction.mobNameList[14]) || a3 == LuckyFunction.mobIDList[14]) {
            return (EntityLiving)new EntityWither(a1);
        }
        /*SL:141*/if (a2.equals(LuckyFunction.mobNameList[15]) || a3 == LuckyFunction.mobIDList[15]) {
            return (EntityLiving)new EntityWitch(a1);
        }
        /*SL:144*/if (a2.equals(LuckyFunction.mobNameList[16]) || a3 == LuckyFunction.mobIDList[16]) {
            return (EntityLiving)new EntityBat(a1);
        }
        /*SL:145*/if (a2.equals(LuckyFunction.mobNameList[17]) || a3 == LuckyFunction.mobIDList[17]) {
            return (EntityLiving)new EntityPig(a1);
        }
        /*SL:146*/if (a2.equals(LuckyFunction.mobNameList[18]) || a3 == LuckyFunction.mobIDList[18]) {
            return (EntityLiving)new EntitySheep(a1);
        }
        /*SL:147*/if (a2.equals(LuckyFunction.mobNameList[19]) || a3 == LuckyFunction.mobIDList[19]) {
            return (EntityLiving)new EntityCow(a1);
        }
        /*SL:148*/if (a2.equals(LuckyFunction.mobNameList[20]) || a3 == LuckyFunction.mobIDList[20]) {
            return (EntityLiving)new EntityChicken(a1);
        }
        /*SL:149*/if (a2.equals(LuckyFunction.mobNameList[21]) || a3 == LuckyFunction.mobIDList[21]) {
            return (EntityLiving)new EntitySquid(a1);
        }
        /*SL:150*/if (a2.equals(LuckyFunction.mobNameList[22]) || a3 == LuckyFunction.mobIDList[22]) {
            return (EntityLiving)new EntityWolf(a1);
        }
        /*SL:151*/if (a2.equals(LuckyFunction.mobNameList[23]) || a3 == LuckyFunction.mobIDList[23]) {
            return (EntityLiving)new EntityMooshroom(a1);
        }
        /*SL:152*/if (a2.equals(LuckyFunction.mobNameList[24]) || a3 == LuckyFunction.mobIDList[24]) {
            return (EntityLiving)new EntitySnowman(a1);
        }
        /*SL:153*/if (a2.equals(LuckyFunction.mobNameList[25]) || a3 == LuckyFunction.mobIDList[25]) {
            return (EntityLiving)new EntityOcelot(a1);
        }
        /*SL:154*/if (a2.equals(LuckyFunction.mobNameList[26]) || a3 == LuckyFunction.mobIDList[26]) {
            return (EntityLiving)new EntityIronGolem(a1);
        }
        /*SL:155*/if (a2.equals(LuckyFunction.mobNameList[27]) || a3 == LuckyFunction.mobIDList[27]) {
            return (EntityLiving)new EntityHorse(a1);
        }
        /*SL:156*/if (a2.equals(LuckyFunction.mobNameList[28]) || a3 == LuckyFunction.mobIDList[28]) {
    ...
    public static Entity getEntity(final World a1, final int a2, final String a3) {
        /*SL:163*/if (!EntityList.field_75627_a.containsKey(a2)) {
            /*SL:165*/return EntityList.func_75620_a(a3, a1);
        }
        /*SL:169*/return EntityList.func_75616_a(a2, a1);
    }
    
    public static int getRandomStatusEffect() {
        final Object[] v1 = /*EL:175*/Potion.func_181168_c().toArray();
        /*SL:176*/return GameData.getPotionRegistry().getId((ResourceLocation)v1[LuckyFunction.random.nextInt(v1.length)]);
    }
