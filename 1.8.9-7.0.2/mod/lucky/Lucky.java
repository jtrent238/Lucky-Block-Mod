...
@Mod(modid = "lucky", name = "Lucky Block", version = "7.0.2", acceptedMinecraftVersions = "[1.8.9]")
public class Lucky
{
    @Mod.Instance("lucky")
    ...
    public void init(final FMLInitializationEvent a1) {
        ...
        MinecraftForge.EVENT_BUS.register(/*EL:114*/(Object)this.tickHandler);
        /*SL:116*/Rotations.registerRotationHandlers();
        Lucky.proxy.register();
    }
    
    public static Lucky getInstance() {
        /*SL:122*/return Lucky.instance;
    }
    ...
    public ResourceLoader getResourceLoader() {
        /*SL:133*/return this.resourceLoader;
    }
    
    public LuckyTickHandler getTickHandler() {
        /*SL:138*/return this.tickHandler;
    }
    
    public static ArrayList<Structure> getStructures() {
        /*SL:143*/return Lucky.structures;
    }
    
    public static Structure getStructure(final String v1) {
        /*SL:148*/for (final Structure a1 : Lucky.structures) {
            /*SL:149*/if (v1.equals(a1.getId())) {
                return a1;
            }
        }
        /*SL:150*/return null;
    ...
    public static void addStructure(final Structure a1) {
        Lucky.structures.add(/*EL:155*/a1);
    }
    
    static {
        Lucky.MODID = "lucky";
        Lucky.VERSION = "7.0.2";
        Lucky.MC_VERSION = "1.8.9";
    }
}
