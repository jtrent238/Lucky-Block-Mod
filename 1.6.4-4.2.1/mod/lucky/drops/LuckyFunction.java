...
public class LuckyFunction
{
    ...
    public static int getPotionDamage() {
        ...
        /*SL:168*/return potionEffect + n + n2 + v;
    }
    
    public static int getPotionEffect() {
        final Random v1 = /*EL:173*/new Random();
        /*SL:174*/return LuckyFunction.potionEffectList[v1.nextInt(LuckyFunction.potionEffectList.length)];
    }
    
    @Deprecated
    public static og getMob(final abw a1, final String a2, final int a3) {
        /*SL:181*/if (a2.equals(LuckyFunction.mobNameList[0]) || a3 == LuckyFunction.mobIDList[0]) {
            return (og)new tf(a1);
        }
        /*SL:182*/if (a2.equals(LuckyFunction.mobNameList[1]) || a3 == LuckyFunction.mobIDList[1]) {
            return (og)new tr(a1);
        }
        /*SL:183*/if (a2.equals(LuckyFunction.mobNameList[2]) || a3 == LuckyFunction.mobIDList[2]) {
            return (og)new tt(a1);
        }
        /*SL:184*/if (a2.equals(LuckyFunction.mobNameList[3]) || a3 == LuckyFunction.mobIDList[3]) {
            return (og)new tk(a1);
        }
        /*SL:185*/if (a2.equals(LuckyFunction.mobNameList[4]) || a3 == LuckyFunction.mobIDList[4]) {
            return (og)new tw(a1);
        }
        /*SL:186*/if (a2.equals(LuckyFunction.mobNameList[5]) || a3 == LuckyFunction.mobIDList[5]) {
            return (og)new ts(a1);
        }
        /*SL:187*/if (a2.equals(LuckyFunction.mobNameList[6]) || a3 == LuckyFunction.mobIDList[6]) {
            return (og)new tj(a1);
        }
        /*SL:188*/if (a2.equals(LuckyFunction.mobNameList[7]) || a3 == LuckyFunction.mobIDList[7]) {
            return (og)new tn(a1);
        }
        /*SL:189*/if (a2.equals(LuckyFunction.mobNameList[8]) || a3 == LuckyFunction.mobIDList[8]) {
            return (og)new tg(a1);
        }
        /*SL:190*/if (a2.equals(LuckyFunction.mobNameList[9]) || a3 == LuckyFunction.mobIDList[9]) {
            return (og)new te(a1);
        }
        /*SL:191*/if (a2.equals(LuckyFunction.mobNameList[10]) || a3 == LuckyFunction.mobIDList[10]) {
            return (og)new tq(a1);
        }
        /*SL:192*/if (a2.equals(LuckyFunction.mobNameList[11]) || a3 == LuckyFunction.mobIDList[11]) {
            return (og)new td(a1);
        }
        /*SL:193*/if (a2.equals(LuckyFunction.mobNameList[12]) || a3 == LuckyFunction.mobIDList[12]) {
            return (og)new tl(a1);
        }
        /*SL:194*/if (a2.equals(LuckyFunction.mobNameList[13]) || a3 == LuckyFunction.mobIDList[13]) {
            return (og)new sk(a1);
        }
        /*SL:195*/if (a2.equals(LuckyFunction.mobNameList[14]) || a3 == LuckyFunction.mobIDList[14]) {
            return (og)new sm(a1);
        }
        /*SL:196*/if (a2.equals(LuckyFunction.mobNameList[15]) || a3 == LuckyFunction.mobIDList[15]) {
            return (og)new tv(a1);
        }
        /*SL:199*/if (a2.equals(LuckyFunction.mobNameList[16]) || a3 == LuckyFunction.mobIDList[16]) {
            return (og)new ro(a1);
        }
        /*SL:200*/if (a2.equals(LuckyFunction.mobNameList[17]) || a3 == LuckyFunction.mobIDList[17]) {
            return (og)new ry(a1);
        }
        /*SL:201*/if (a2.equals(LuckyFunction.mobNameList[18]) || a3 == LuckyFunction.mobIDList[18]) {
            return (og)new rz(a1);
        }
        /*SL:202*/if (a2.equals(LuckyFunction.mobNameList[19]) || a3 == LuckyFunction.mobIDList[19]) {
            return (og)new rr(a1);
        }
        /*SL:203*/if (a2.equals(LuckyFunction.mobNameList[20]) || a3 == LuckyFunction.mobIDList[20]) {
            return (og)new rq(a1);
        }
        /*SL:204*/if (a2.equals(LuckyFunction.mobNameList[21]) || a3 == LuckyFunction.mobIDList[21]) {
            return (og)new sc(a1);
        }
        /*SL:205*/if (a2.equals(LuckyFunction.mobNameList[22]) || a3 == LuckyFunction.mobIDList[22]) {
            return (og)new sf(a1);
        }
        /*SL:206*/if (a2.equals(LuckyFunction.mobNameList[23]) || a3 == LuckyFunction.mobIDList[23]) {
            return (og)new rw(a1);
        }
        /*SL:207*/if (a2.equals(LuckyFunction.mobNameList[24]) || a3 == LuckyFunction.mobIDList[24]) {
            return (og)new sb(a1);
        }
        /*SL:208*/if (a2.equals(LuckyFunction.mobNameList[25]) || a3 == LuckyFunction.mobIDList[25]) {
            return (og)new rx(a1);
        }
        /*SL:209*/if (a2.equals(LuckyFunction.mobNameList[26]) || a3 == LuckyFunction.mobIDList[26]) {
            return (og)new sd(a1);
        }
        /*SL:210*/if (a2.equals(LuckyFunction.mobNameList[27]) || a3 == LuckyFunction.mobIDList[27]) {
            return (og)new rs(a1);
        }
        /*SL:211*/if (a2.equals(LuckyFunction.mobNameList[28]) || a3 == LuckyFunction.mobIDList[28]) {
            return (og)new ub(a1);
        }
        /*SL:213*/return null;
    }
    ...
    public static nn getEntity(final abw a1, final int a2, final String a3) {
        /*SL:218*/if (!nt.a.containsKey(a2)) {
            /*SL:220*/return nt.a(a3, a1);
        }
        /*SL:224*/return nt.a(a2, a1);
    }
    
    public static int getMobEgg() {
        final Random v1 = /*EL:230*/new Random();
        /*SL:231*/return LuckyFunction.mobEggList[v1.nextInt(LuckyFunction.mobEggList.length)];
    }
    
    public static void setOffset(final int a1, final int a2) {
        final Random v1 = /*EL:236*/new Random();
        int v2;
        int v3;
        /*SL:246*/do {
        ...
        LuckyFunction.XOffset = /*EL:248*/v2;
        LuckyFunction.ZOffset = /*EL:249*/v3;
    }
    
    public static int getXOffset() {
        /*SL:258*/return LuckyFunction.XOffset;
    }
    
    public static int getZOffset() {
        /*SL:263*/return LuckyFunction.ZOffset;
    }
    
    public static int getPlayerDirection(final uf a1, int a2) {
        int v1 = /*EL:268*/(int)a1.A;
        /*SL:270*/a2 = 360 / a2;
        /*SL:272*/if (v1 < 0) {
            v1 += 360;
        }
        /*SL:273*/v1 += a2 / 2;
        /*SL:274*/v1 %= 360;
        final int v2 = /*EL:276*/v1 / a2;
        /*SL:278*/return v2;
    }
    
    public static int adjustHeight(final abw a2, final int a3, final int a4, final int a5, final int v1) {
        boolean v2 = /*EL:283*/false;
        int v3 = /*EL:284*/a5;
        int v4 = /*EL:285*/0;
        /*SL:286*/for (int a6 = a5; a6 < a5 + 16; ++a6) {
            /*SL:288*/if (aqz.t[a2.a(a4, a6, v1)]) {
                /*SL:290*/v4 = 0;
                /*SL:291*/v3 = a6 + 1;
            }
            else {
