...
public class LuckyFunction
{
    ...
    public static Entity getEntity(final World a1, final int a2, final String a3) {
        /*SL:180*/if (!EntityList.field_75627_a.containsKey(a2)) {
            /*SL:182*/return EntityList.func_75620_a(a3, a1);
        }
        /*SL:186*/return EntityList.func_75616_a(a2, a1);
    }
    
    public static int getRandomStatusEffect() {
        /*SL:192*/return Potion.field_188414_b.func_148757_b(Potion.field_188414_b.func_186801_a(LuckyFunction.random));
    }
    
    public static int getRandomPotionEffect() {
        /*SL:197*/return LuckyFunction.random.nextInt(14) + 1;
    }
    
    public static int getRandomPotionEffectGood() {
        /*SL:202*/return LuckyFunction.potionEffectListGood[LuckyFunction.random.nextInt(LuckyFunction.potionEffectListGood.length)];
    }
    
    public static int getRandomPotionEffectBad() {
        /*SL:207*/return LuckyFunction.potionEffectListBad[LuckyFunction.random.nextInt(LuckyFunction.potionEffectListBad.length)];
    }
    ...
    public static int getRandomMobEggID() {
        ...
        /*SL:214*/return EntityList.func_180122_a(v2.field_75613_a);
    }
    
    public static String getRandomMobEggName() {
        final Object[] v1 = EntityList.field_75627_a.values().toArray();
        final EntityList.EntityEggInfo v2 = /*EL:220*/(EntityList.EntityEggInfo)v1[LuckyFunction.random.nextInt(v1.length)];
        /*SL:221*/return v2.field_75613_a;
    }
    
    public static int getPlayerDirection(final EntityPlayer a1, final int a2) {
        int v1 = /*EL:226*/(int)a1.field_70177_z;
        final int v2 = /*EL:227*/360 / a2;
        /*SL:228*/if (v1 < 0) {
            v1 += 360;
        }
        /*SL:229*/v1 += v2 / 2;
    ...
    public static int adjustHeight(final World a2, final int a3, final int a4, final int a5, final int v1) {
        boolean v2 = /*EL:236*/false;
        int v3 = /*EL:237*/a5;
        int v4 = /*EL:238*/0;
        /*SL:239*/for (int a6 = a5; a6 < a5 + 16; ++a6) {
            /*SL:241*/if (a2.func_180495_p(new BlockPos(a4, a6, v1)).func_185914_p()) {
                /*SL:243*/v4 = 0;
                /*SL:244*/v3 = a6 + 1;
            }
            else {
    ...
    public static NBTTagList getNBTTagListFromStringArray(final String[] v1) {
        final NBTTagList v2 = /*EL:270*/new NBTTagList();
        /*SL:271*/for (final String a1 : v1) {
            /*SL:273*/v2.func_74742_a((NBTBase)new NBTTagString(a1));
        }
        /*SL:275*/return v2;
    }
    
    public static String[] getStringArrayFromNBTTagList(final NBTTagList v1) {
        final String[] v2 = /*EL:280*/new String[(v1 == null) ? 0 : v1.func_74745_c()];
        /*SL:281*/for (int a1 = 0; a1 < v2.length; ++a1) {
            /*SL:283*/v2[a1] = v1.func_150307_f(a1);
        }
        /*SL:285*/return v2;
    }
    
    public static ArrayList<DropContainer> getDropsFromStringArray(final String[] v-4) {
        final ArrayList<DropContainer> list = /*EL:290*/new ArrayList<DropContainer>();
        /*SL:291*/for (final String v1 : v-4) {
            final DropContainer a1 = /*EL:293*/new DropContainer();
            /*SL:294*/a1.readFromString(v1);
            /*SL:295*/list.add(a1);
        }
        /*SL:297*/return list;
    }
