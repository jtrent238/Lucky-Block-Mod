...
public class ItemLuckySword extends ItemSword
{
    ...
    public boolean func_77644_a(final ItemStack v2, final EntityLivingBase v3, final EntityLivingBase v4) {
        try {
            final int a1 = /*EL:45*/ItemLuckyBlock.getLuck(v2);
            final String[] a2 = /*EL:46*/ItemLuckyBlock.getDrops(v2);
            /*SL:48*/if (a2 != null && a2.length != 0) {
                ...
                /*SL:49*/this.getDropProcessor().processRandomDrop(new DropProcessData(v4.func_130014_f_(), (Entity)v4, v3.func_174791_d()).setHitEntity((Entity)v3), a1);
            }
        }
        catch (Exception a3) {
            System.err.println(/*EL:53*/"The Lucky Sword encountered and error while trying to perform a function. Error report below:");
            /*SL:54*/a3.printStackTrace();
        }
        /*SL:57*/return super.func_77644_a(v2, v3, v4);
    }
