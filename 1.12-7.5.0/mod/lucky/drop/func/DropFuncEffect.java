...
public class DropFuncEffect extends DropFunction
{
    ...
    public void process(final DropProcessData v-5) {
        ...
        final AxisAlignedBB func_72321_a = /*EL:24*/new AxisAlignedBB(dropProperties.getBlockPos(), dropProperties.getBlockPos()).func_72321_a((double)(dropProperties.getPropertyInt("range") * 2), (double)(dropProperties.getPropertyInt("range") * 2), (double)(dropProperties.getPropertyInt("range") * 2));
        ...
        else/*SL:50*/ if (func_72321_a != null) {
            final List v = /*EL:52*/v-5.getWorld().func_72872_a((Class)EntityLivingBase.class, func_72321_a);
            /*SL:53*/if (!v.isEmpty()) {
