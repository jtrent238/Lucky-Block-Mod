...
public class TileEntityLuckyBlock extends TileEntity implements ITickable
{
    ...
    public NBTTagCompound func_189515_b(final NBTTagCompound a1) {
        /*SL:22*/super.func_189515_b(a1);
        /*SL:23*/a1.func_74782_a("Drops", (NBTBase)LuckyFunction.getNBTTagListFromStringArray(this.drops));
    ...
    public SPacketUpdateTileEntity func_189518_D_() {
        ...
        /*SL:40*/this.func_189515_b(v1);
        /*SL:41*/return new SPacketUpdateTileEntity(new BlockPos(this.field_174879_c.func_177958_n(), this.field_174879_c.func_177956_o(), this.field_174879_c.func_177952_p()), 1, v1);
    }
