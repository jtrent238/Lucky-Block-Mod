...
public class ExpressionParserOld
{
    ...
    public NBTBase getFormattedNBT(final NBTBase v-2) {
        /*SL:338*/if (v-2 instanceof NBTTagString) {
            try {
                /*SL:342*/return this.getNBTValueFromString(((NBTTagString)v-2).func_150285_a_());
            }
            catch (Exception ex) {}
        }
        /*SL:348*/if (v-2 instanceof NBTTagCompound) {
            /*SL:350*/for (final Object v0 : ((NBTTagCompound)v-2).func_150296_c()) {
                final NBTBase v = /*EL:352*/this.getFormattedNBT(((NBTTagCompound)v-2).func_74781_a((String)v0));
                /*SL:353*/((NBTTagCompound)v-2).func_74782_a((String)v0, v);
            }
        }
        /*SL:356*/if (v-2 instanceof NBTTagList) {
            /*SL:358*/if (((NBTTagList)v-2).func_150303_d() == 8) {
                /*SL:360*/for (int i = 0; i < ((NBTTagList)v-2).func_74745_c(); ++i) {
                    final String v2 = /*EL:362*/((NBTTagList)v-2).func_150307_f(i);
                    final NBTBase v = /*EL:363*/this.getNBTValueFromString(v2);
                    /*SL:364*/((NBTTagList)v-2).func_150304_a(i, v);
                }
            }
            /*SL:367*/if (((NBTTagList)v-2).func_150303_d() == 10) {
                /*SL:369*/for (int i = 0; i < ((NBTTagList)v-2).func_74745_c(); ++i) {
                    final NBTTagCompound v3 = /*EL:371*/((NBTTagList)v-2).func_150305_b(i);
                    final NBTTagCompound v4 = /*EL:372*/(NBTTagCompound)this.getFormattedNBT((NBTBase)v3);
                    /*SL:373*/((NBTTagList)v-2).func_150304_a(i, (NBTBase)v4);
                }
            }
        }
        /*SL:377*/return v-2;
    ...
    private Object getFormattedObject(final String v2) {
        Object v3 = /*EL:395*/v2;
        try {
            /*SL:398*/if (v2.endsWith("d") || v2.endsWith("D")) {
                v3 = this.getDouble(v2.substring(0, v2.length() - 1));
            }
            else/*SL:399*/ if (v2.endsWith("f") || v2.endsWith("F")) {
                v3 = this.getFloat(v2.substring(0, v2.length() - 1));
            }
            else/*SL:400*/ if (v2.endsWith("s") || v2.endsWith("S")) {
                v3 = this.getShort(v2.substring(0, v2.length() - 1));
            }
            else/*SL:401*/ if (v2.endsWith("b") || v2.endsWith("B")) {
                v3 = this.getByte(v2.substring(0, v2.length() - 1));
            }
        }
        catch (Exception ex) {}
        /*SL:406*/return v3;
                ...
                /*SL:621*/if (s != null) {
                    if (!s.equals("")) {
                        ...
                        /*SL:643*/if (v-10.startsWith("#") && v0 != null) {
                            ...
                            final NBTTagCompound v = /*EL:649*/new NBTTagCompound();
                            /*SL:650*/this.getNBTTag((NBTBase)v, v-10);
                            /*SL:651*/this.setTagValue(v-9, s2, v);
                        }
                        else/*SL:653*/ if (v-10.startsWith("[") && v-10.endsWith("]")) {
                            final NBTTagList v2 = /*EL:655*/new NBTTagList();
                            /*SL:656*/this.getNBTTag((NBTBase)v2, v-10);
                            /*SL:657*/this.setTagValue(v-9, s2, v2);
                        }
                            ...
                            try {
                                ...
                                try {
                                    ...
                                    try {
                                        ...
                                        try {
                                            final String[] v3 = /*EL:689*/v-10.split(":");
                                            /*SL:690*/if (v3.length == 0) {
                                                throw new ExpressionParserException();
                                            }
                                            int v4 = /*EL:692*/0;
                                            /*SL:693*/if (v3[0].endsWith("b") || v3[0].endsWith("B")) {
                                                v4 = 1;
                                            }
                                            final int[] v5 = /*EL:695*/new int[v3.length];
                                            final byte[] v6 = /*EL:696*/new byte[v3.length];
                                            /*SL:697*/for (int v7 = 0; v7 < v3.length; ++v7) {
                                                /*SL:699*/if (v4 == 0) {
                                                    v5[v7] = this.getInteger(v3[v7]);
                                                }
                                                else {
                                                    /*SL:702*/v3[v7] = this.removeSuffix(v3[v7]);
                                                    /*SL:703*/v6[v7] = this.getByte(v3[v7]);
                                                }
                                            }
                                            /*SL:707*/if (v4 == 0) {
                                                /*SL:709*/if (v5.length == 0) {
                                                    throw new ExpressionParserException();
                                                }
                                                /*SL:710*/this.setTagValue(v-9, s2, v5);
                                            }
                                            else {
                                                /*SL:714*/if (v6.length == 0) {
                                                    throw new ExpressionParserException();
                                                }
                                                /*SL:715*/this.setTagValue(v-9, s2, v6);
                                            }
                                        }
                                        catch (ExpressionParserException v11) {
