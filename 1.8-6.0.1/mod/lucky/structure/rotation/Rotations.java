...
public final class Rotations
{
    ...
    public static Vec3 rotatePos(final Vec3 v1, final Vec3 v2, int v3) {
        /*SL:59*/v3 %= 4;
        /*SL:60*/if (v3 < 0) {
            v3 += 4;
        }
        ...
        /*SL:73*/return new Vec3(v4 + v2.field_72450_a, v5 + v2.field_72448_b, v2.field_72449_c - v6);
    }
    
    public static BlockPos rotatePos(final BlockPos a1, final BlockPos a2, final int a3) {
        final Vec3 v1 = rotatePos(/*EL:78*/new Vec3((double)a1.func_177958_n(), (double)a1.func_177956_o(), (double)a1.func_177952_p()), new Vec3((double)a2.func_177958_n(), (double)a2.func_177956_o(), (double)a2.func_177952_p()), a3);
        /*SL:79*/return new BlockPos(v1.field_72450_a, v1.field_72448_b, v1.field_72449_c);
    }
    
    public static BlockPos rotatePos(final BlockPos a1, final Vec3 a2, final int a3) {
        final Vec3 v1 = rotatePos(/*EL:84*/new Vec3((double)a1.func_177958_n(), (double)a1.func_177956_o(), (double)a1.func_177952_p()), a2, a3);
        /*SL:85*/return new BlockPos(v1.field_72450_a, v1.field_72448_b, v1.field_72449_c);
    }
    ...
    public static NBTTagCompound rotateEntity(final NBTTagCompound v-3, final Vec3 v-2, int v-1) {
        /*SL:99*/v-1 %= 4;
        /*SL:100*/if (v-1 < 0) {
            v-1 += 4;
        }
        /*SL:102*/if (v-3.func_74764_b("Pos")) {
            ...
            Vec3 a2 = /*EL:105*/new Vec3(a1.func_150309_d(0), a1.func_150309_d(1), a1.func_150309_d(2));
        ...
        /*SL:114*/if (v-3.func_74764_b("Motion")) {
            ...
            Vec3 v1 = /*EL:117*/new Vec3(a3.func_150309_d(0), a3.func_150309_d(1), a3.func_150309_d(2));
            /*SL:118*/v1 = rotatePos(v1, new Vec3(0.0, 0.0, 0.0), v-1);
    ...
    public static Entity rotateEntity(final Entity a1, int a2) {
        ...
        final Vec3 v1 = rotatePos(/*EL:144*/new Vec3(a1.field_70159_w, a1.field_70181_x, a1.field_70179_y), new Vec3(0.0, 0.0, 0.0), a2);
    ...
    public static void registerRotationHandlers() {
        ...
        /*SL:169*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_150324_C)] = new ArrayStateRotationHandler((IProperty)BlockBed.field_176387_N, (Comparable[])v1);
        /*SL:170*/Rotations.stateRotationHandlers[Block.func_149682_b((Block)Blocks.field_150331_J)] = new ArrayStateRotationHandler((IProperty)BlockPistonBase.field_176321_a, (Comparable[])v1);
        /*SL:171*/Rotations.stateRotationHandlers[Block.func_149682_b((Block)Blocks.field_150320_F)] = new ArrayStateRotationHandler((IProperty)BlockPistonBase.field_176321_a, (Comparable[])v1);
        /*SL:172*/Rotations.stateRotationHandlers[Block.func_149682_b((Block)Blocks.field_150332_K)] = new ArrayStateRotationHandler((IProperty)BlockPistonExtension.field_176326_a, (Comparable[])v1);
        ...
        /*SL:189*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_180413_ao)] = new ArrayStateRotationHandler((IProperty)BlockDoor.field_176520_a, (Comparable[])v1);
        /*SL:190*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_150454_av)] = new ArrayStateRotationHandler((IProperty)BlockDoor.field_176520_a, (Comparable[])v1);
        /*SL:191*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_180414_ap)] = new ArrayStateRotationHandler((IProperty)BlockDoor.field_176520_a, (Comparable[])v1);
        /*SL:192*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_180412_aq)] = new ArrayStateRotationHandler((IProperty)BlockDoor.field_176520_a, (Comparable[])v1);
        /*SL:193*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_180411_ar)] = new ArrayStateRotationHandler((IProperty)BlockDoor.field_176520_a, (Comparable[])v1);
        /*SL:194*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_180410_as)] = new ArrayStateRotationHandler((IProperty)BlockDoor.field_176520_a, (Comparable[])v1);
        /*SL:195*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_180409_at)] = new ArrayStateRotationHandler((IProperty)BlockDoor.field_176520_a, (Comparable[])v1);
        ...
        /*SL:218*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_150430_aB)] = new ArrayStateRotationHandler((IProperty)BlockButton.field_176585_a, (Comparable[])v1);
        /*SL:219*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_150471_bO)] = new ArrayStateRotationHandler((IProperty)BlockButton.field_176585_a, (Comparable[])v1);
        /*SL:220*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_150423_aK)] = new ArrayStateRotationHandler((IProperty)BlockPumpkin.field_176387_N, (Comparable[])v1);
        /*SL:221*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_150428_aP)] = new ArrayStateRotationHandler((IProperty)BlockPumpkin.field_176387_N, (Comparable[])v1);
        /*SL:222*/Rotations.stateRotationHandlers[Block.func_149682_b((Block)Blocks.field_150413_aR)] = new ArrayStateRotationHandler((IProperty)BlockRedstoneRepeater.field_176387_N, (Comparable[])v1);
        /*SL:223*/Rotations.stateRotationHandlers[Block.func_149682_b((Block)Blocks.field_150416_aS)] = new ArrayStateRotationHandler((IProperty)BlockRedstoneRepeater.field_176387_N, (Comparable[])v1);
        /*SL:224*/Rotations.stateRotationHandlers[Block.func_149682_b((Block)Blocks.field_150441_bU)] = new ArrayStateRotationHandler((IProperty)BlockRedstoneComparator.field_176387_N, (Comparable[])v1);
        /*SL:225*/Rotations.stateRotationHandlers[Block.func_149682_b((Block)Blocks.field_150455_bV)] = new ArrayStateRotationHandler((IProperty)BlockRedstoneComparator.field_176387_N, (Comparable[])v1);
        ...
        /*SL:232*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_150395_bd)] = new StateRotationHandler() {
            ...
            public IBlockState rotate(final IBlockState v-7, final int v-6) {
                Comparable func_177229_b = /*EL:237*/v-7.func_177229_b((IProperty)BlockVine.field_176273_b);
                Comparable func_177229_b2 = v-7.func_177229_b((IProperty)BlockVine.field_176278_M);
                Comparable func_177229_b3 = v-7.func_177229_b((IProperty)BlockVine.field_176279_N);
                Comparable func_177229_b4 = v-7.func_177229_b((IProperty)BlockVine.field_176280_O);
                /*SL:240*/for (Comparable v3 = 0; v3 < v-6; ++v3) {
                    final Comparable a1 = /*EL:242*/func_177229_b4;
                    final Comparable a2 = /*EL:243*/func_177229_b;
                    final Comparable v2 = /*EL:244*/func_177229_b2;
                    /*SL:245*/v3 = func_177229_b3;
                    /*SL:246*/func_177229_b = a1;
                    /*SL:247*/func_177229_b2 = a2;
                    /*SL:248*/func_177229_b3 = v2;
                    /*SL:249*/func_177229_b4 = v3;
                }
                /*SL:252*/return v-7.func_177226_a((IProperty)BlockVine.field_176273_b, func_177229_b).func_177226_a((IProperty)BlockVine.field_176278_M, func_177229_b2).func_177226_a((IProperty)BlockVine.field_176279_N, func_177229_b3).func_177226_a((IProperty)BlockVine.field_176280_O, func_177229_b4);
            }
        };
        /*SL:255*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_180390_bo)] = new ArrayStateRotationHandler((IProperty)BlockFenceGate.field_176387_N, (Comparable[])v1);
        /*SL:256*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_180391_bp)] = new ArrayStateRotationHandler((IProperty)BlockFenceGate.field_176387_N, (Comparable[])v1);
        /*SL:257*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_180392_bq)] = new ArrayStateRotationHandler((IProperty)BlockFenceGate.field_176387_N, (Comparable[])v1);
        /*SL:258*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_180386_br)] = new ArrayStateRotationHandler((IProperty)BlockFenceGate.field_176387_N, (Comparable[])v1);
        /*SL:259*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_180385_bs)] = new ArrayStateRotationHandler((IProperty)BlockFenceGate.field_176387_N, (Comparable[])v1);
        /*SL:260*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_180387_bt)] = new ArrayStateRotationHandler((IProperty)BlockFenceGate.field_176387_N, (Comparable[])v1);
        /*SL:261*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_150378_br)] = new ArrayStateRotationHandler((IProperty)BlockEndPortalFrame.field_176508_a, (Comparable[])v1);
        /*SL:262*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_150375_by)] = new ArrayStateRotationHandler((IProperty)BlockCocoa.field_176387_N, (Comparable[])v1);
        /*SL:263*/Rotations.stateRotationHandlers[Block.func_149682_b((Block)Blocks.field_150479_bC)] = new ArrayStateRotationHandler((IProperty)BlockTripWireHook.field_176264_a, (Comparable[])v1);
        /*SL:264*/Rotations.stateRotationHandlers[Block.func_149682_b((Block)Blocks.field_150465_bP)] = new ArrayStateRotationHandler((IProperty)BlockSkull.field_176418_a, (Comparable[])v1);
        /*SL:265*/Rotations.tileEntityRotationHandlers[Block.func_149682_b((Block)Blocks.field_150465_bP)] = new TileEntityRotationHandler() {
            @Override
            public void rotate(final TileEntity a1, final int a2) {
                final TileEntitySkull v1 = /*EL:270*/(TileEntitySkull)a1;
                /*SL:271*/v1.func_145903_a((v1.func_145906_b() + a2 * 4) % 16);
            }
        };
        /*SL:274*/Rotations.stateRotationHandlers[Block.func_149682_b(Blocks.field_150467_bQ)] = new ArrayStateRotationHandler((IProperty)BlockAnvil.field_176506_a, (Comparable[])v1);
    }
