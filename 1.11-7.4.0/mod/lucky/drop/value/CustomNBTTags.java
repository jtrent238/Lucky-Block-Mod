    ...
    public static NBTBase getNBTTagFromString(String v-1, final DropProcessData v0) {
        ...
        /*SL:245*/if (v-1.startsWith("#bowMotion")) {
            try {
                ...
                /*SL:265*/v19.func_184547_a(v18, v18.field_70125_A + HashVariables.randomFloatClamp(v0.getWorld().field_73012_v, -v15, v15), v18.field_70177_z + HashVariables.randomFloatClamp(v0.getWorld().field_73012_v, -v15, v15), 0.0f, v0.getBowPower(), 1.0f);
